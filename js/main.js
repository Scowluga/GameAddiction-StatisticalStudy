...
if (debugmode) {
      $("#highScoreDisplay").html("Wide: " + isEasy + "<br>" + "hasScore: " + hasScore);
}
...
function showScore()
{
   ...
   if (hasScore) {
      ...
      $("#scoreboard").transition({ y: '0px', opacity: 1}, 600, 'ease', function() {
         ...
         soundSwoosh.stop();
         soundSwoosh.play();
         $("#gameover").transition({ y: '0px', opacity: 1}, 600, 'ease');
      
      });
      $("#scoreboard").css("background-image", 'url("' + '../assets/scoreboard.png' + '")');
      // $("#scoreboard").css("background-image", "url('" + '../assets/scoreboard.png' + "')");
   }
